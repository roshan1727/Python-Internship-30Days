...
# window.configure(background="Hot pink")
...
label_0= Label(window,text="Employee Registration Form",font = ("bold",20))
...
var1=IntVar()
Checkbutton(window,text= "accept terms and condition", variable=var1).place(x=100,y=400)
#fubction declaration
def clicked():
        res = "Welcome to " + txt.get()
        lbl.configure(text= res)
btn = ttk.Button(window ,text="Submit").place(x = 100,y=450)
window.mainloop()